...
class Channel_S_Button:
    def __init__(self,master,port_button,button_place):
        self.port_button = port_button
        self.master = master
        self.button = Button(button_place,text='Channel',compound=TOP,command=self.click)
    ...
    def click(self):
        ...
        if self.channel_created:
            cha     = Channel_S(self.master.master,self,self.port_button)
            cha.num = self.count
...
class Channel_S_Display:
    def __init__(self,master,channel):
        ...
        self.labels = [' Channel Shape : ',
                       ' Channel Length (mm): ',
                       ' Channel Width (\u03BCm): ',
                       ' Channel Height (\u03BCm): ', # ' Channel Area (\u03BCm\u00b2): ',
                       ' Flow Rate (\u03BCL/s) : ',
                       ]
        self.shape     = '-'
        self.length    = '-'
...
class Channel_S_Edit:
    def __init__(self,master,channel):
        self.channel = channel
        self.master  = master
        self.window  = master
        self.window.geometry(f'630x100-10000-100000')# 900x100 630x150 original ('550x150+450+400')
    ...
    def save_changes(self):
        ...
        self.channel.display.length    = self.values[1]
        self.channel.display.width     = self.values[2]
        self.channel.display.height    = self.values[3]
        self.channel.display.flow_rate = self.values[4]
...
class Channel_S:
    def __init__(self,master,channel_button,port_button):
        ...
        self.display         = Channel_S_Display(self.disp_win,self)
        self.edit            = Channel_S_Edit(   self.edit_win,self)
        ...
        self.channel         = self.master.create_line(0,0,0,0,dash=(10,2),width=2,tags='line')
